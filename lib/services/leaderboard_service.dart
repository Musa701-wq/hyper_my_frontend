...
class LeaderboardService {
  ...
  Future<List<TraderSnapshot>> getTraderSnapshots(String address) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded is List) {
          ...
          raw = decoded['data'];
        } else if (decoded['data'] is Map && decoded['data']['snapshots'] is List) {
          raw = decoded['data']['snapshots'];
